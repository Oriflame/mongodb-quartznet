...
namespace Quartz.Spi.MongoDbJobStore.Tests
{
    ...
    public class HackedStdSchedulerFactory : ISchedulerFactory
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HackedStdSchedulerFactory"/> class.
        /// </summary>
        public HackedStdSchedulerFactory()
        {
        }
        ...
        public HackedStdSchedulerFactory(NameValueCollection props)
        {
            Initialize(props);
        }
        ...
        public void Initialize()
        {
            ...
            var props = GetSection(ConfigurationSectionName);
...
//                schedRep.Bind(remoteScheduler);
            ...
            SetDetails(js, schedName, schedInstId);
            ...
            try
            {
                ...
                SetDetails(tp, schedName, schedInstId);
...
//            }
            ...
            var sched = await Instantiate().ConfigureAwait(false);
...
//            return SchedulerRepository.Instance.Lookup(schedName, cancellationToken);
        ...
        // Taken from Quartz.Impl.SchedulerDetailsSetter
